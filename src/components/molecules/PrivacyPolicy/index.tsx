...
const PrivacyPolicy = () => (
  <Box aria-labelledby="privacy-policy">
    ...
    <Typography component="p" color="textSecondary">
      L'informativa è resa solo per il sito web ufficiale di la Compagnia d'Arme del Santo Luca all'indirizzo https://{window.location.host} e non per
      altri siti web esterni, eventualmente consultati dall'utente tramite link.
    </Typography>
    ...
    <Typography component="p" color="textSecondary">
      Il Titolare, la Compagnia d'Arme del Santo Luca ente di diritto privato senza fine di lucro, ai sensi dell'art. 37 GDPR, non è tenuto a nominare
    ...
    <Typography component="p" color="textSecondary" gutterBottom>
      ...
      computer utilizzati dagli utenti che si connettono al sito, gli indirizzi in notazione URI (Uniform Resource Identifier) delle risorse
      richieste, l'orario della richiesta, il metodo utilizzato nel sottoporre la richiesta al server, la dimensione del file ottenuto in risposta, il
      codice numerico indicante lo stato della risposta data dal server (buon fine, errore, ecc.) ed altri parametri relativi al sistema operativo e
    ...
    <List dense>
      ...
      <ListItemText>chiedere la comunicazione dei dati personali conservati eventualmente dal Titolare o la consegna di una loro copia;</ListItemText>
